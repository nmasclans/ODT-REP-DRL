...
#
# Run as (e.g.):
# ./mainAll.sh 180 channel180_2_5_2024_longSimulation 0 channel180_2_5_2024_run1710523569 0 2 1 111 1000 1710523569 1 0.1 100
# 
...
echo -e "************************** mainRL.sh ***************************"
echo -e "****************************************************************"
./mainRL.sh "$1" "$2" "$3" "$4" "$5" "$6" "$7" "$8" "$9" "${12}"