...
This repository contains an extended version of the One-Dimensional Turbulence (ODT) model, which incorporates a Deep Reinforcement Learning (DRL) framework to accelerate the statistical convergence of turbulent flow simulations.

The work, contributed by [Núria Masclans](https://github.com/nmasclans), implements a Reynolds Stresses Perturbation (REP)-based DRL framework (REP-DRL). 
This fork is based on the original [ODT](https://github.com/BYUignite/ODT) repository at commit `b438c06`.
...
## Original ODT Documentation

The original [ODT](https://github.com/BYUignite/ODT) model is a tool for simulating turbulent reacting or nonreacting flows. See also the [Basic ODT](https://github.com/BYUignite/basicODT) implementation.
