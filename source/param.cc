...
param::param(inputoutput *p_io) {
    ...
    controller_K_i     = io->params["controller_K_i"]     ? io->params["controller_K_i"].as<double>()  : 1.0;
    controller_K_d     = io->params["controller_K_d"]     ? io->params["controller_K_d"].as<double>()  : 1.0;
